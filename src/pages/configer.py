...
class Ui_ExperimentConfig(object):
    def setupUi(self, ExperimentConfig):
        ...
        self.de_thickness_box_2 = QtWidgets.QDoubleSpinBox(ExperimentConfig)
        self.de_thickness_box_2.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.de_thickness_box_2.setFont(font)
        self.de_thickness_box_2.setStyleSheet("background-color: rgb(85, 85, 127);\ncolor: rgb(255, 255, 255);")
        self.de_thickness_box_2.setMaximum(999999999.99)
        self.de_thickness_box_2.setProperty("value", 5.0)
        self.de_thickness_box_2.setObjectName("de_thickness_box_2")
        self.radius_layout.addWidget(self.de_thickness_box_2)
        ...
        self.de_thickness_box_3 = QtWidgets.QDoubleSpinBox(ExperimentConfig)
        self.de_thickness_box_3.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.de_thickness_box_3.setFont(font)
        self.de_thickness_box_3.setStyleSheet("background-color: rgb(85, 85, 127);\ncolor: rgb(255, 255, 255);")
        self.de_thickness_box_3.setMaximum(999999999.99)
        self.de_thickness_box_3.setProperty("value", 200.0)
        self.de_thickness_box_3.setObjectName("de_thickness_box_3")
        self.distance_layout.addWidget(self.de_thickness_box_3)
